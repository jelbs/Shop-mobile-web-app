...
<div data-role="page">
		...
		<div data-role="navbar">
			<ul>
  				<li><a href="customer.php" class="ui-btn ui-icon-back ui-shadow ui-corner-all ui-btn-icon-left">Return</a></li>
  				<li><a href="customer.php" class="ui-btn ui-icon-home ui-shadow ui-corner-all ui-btn-icon-left">Home</a></li>
  				<li><a href="viewCart.php" class="ui-btn ui-icon-shop ui-shadow ui-corner-all ui-btn-icon-left">Cart</a></li>
